...
# 1 core tests
bash run_assist.sh "main_full" "test_runs/test_distributed_1_core_default" 1 || exit 1
bash run_assist.sh "main_full" "test_runs/test_distributed_1_core_nullmsg" 1 || exit 1
...
if [ "${num_cores}" -ge "4" ]; then
  bash run_assist.sh "main_full" "test_runs/test_distributed_2_core_default" 2 || exit 1
  bash run_assist.sh "main_full" "test_runs/test_distributed_2_core_nullmsg" 2 || exit 1
fi
