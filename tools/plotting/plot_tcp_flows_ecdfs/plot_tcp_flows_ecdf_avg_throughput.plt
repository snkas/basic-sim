...
# Axes labels
set xlabel "Average throughput (Mbit/s)" # Markup: e.g. 99^{th}, {/Symbol s}, {/Helvetica-Italic P}
set ylabel "ECDF (TCP flows)"
...
plot    "[DATA-FILE]" using ($1):($2) title "" with steps ls 1, \
