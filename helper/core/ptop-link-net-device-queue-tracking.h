...
namespace ns3 {
    ...
    class PtopLinkNetDeviceQueueTracking
    {

    public:
        PtopLinkNetDeviceQueueTracking(Ptr<BasicSimulation> basicSimulation, Ptr<TopologyPtop> topology);
        void WriteResults();
    ...
    private:
        ...
        std::string m_filename_link_net_device_queue_pkt_csv;
        std::string m_filename_link_net_device_queue_byte_csv;
