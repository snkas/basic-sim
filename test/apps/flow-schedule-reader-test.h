...
void cleanup_flow_schedule_reader_test() {
    ...
    remove_file_if_exists(flow_schedule_reader_test_dir + "/flow_schedule.csv");
...
public:
    ...
    void DoRun () {
        ...
        std::vector<FlowScheduleEntry> schedule = read_flow_schedule(flow_schedule_reader_test_dir + "/flow_schedule.csv", topology, 10000000000);
        ...
        std::ofstream schedule_file_empty(flow_schedule_reader_test_dir + "/flow_schedule.csv");
        schedule_file_empty.close();
        std::vector<FlowScheduleEntry> schedule_empty = read_flow_schedule(flow_schedule_reader_test_dir + "/flow_schedule.csv", topology, 10000000);
...
public:
    ...
    void DoRun () {
        ...
        // Normal
        schedule_file = std::ofstream(flow_schedule_reader_test_dir + "/flow_schedule.csv");
        schedule_file << "0,0,4,100000,1356567,a=b,test" << std::endl;
        schedule_file.close();
        schedule = read_flow_schedule(flow_schedule_reader_test_dir + "/flow_schedule.csv", topology, 10000000);

        // Source = Destination
        schedule_file = std::ofstream(flow_schedule_reader_test_dir + "/flow_schedule.csv");
        schedule_file << "0,3,3,100000,1356567,a=b,test" << std::endl;
        schedule_file.close();
        ASSERT_EXCEPTION(read_flow_schedule(flow_schedule_reader_test_dir + "/flow_schedule.csv", topology, 10000000));
        ...
        schedule_file.close();
        ASSERT_EXCEPTION(schedule = read_flow_schedule(flow_schedule_reader_test_dir + "/flow_schedule.csv", topology, 10000000));
